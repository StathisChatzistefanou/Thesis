...
# Ορισμός συνάρτησης για προ-επεξεργασία εικόνας
...
# Φόρτωση αποθηκευμένου μοντέλου χρησιμοποιώντας το pickle
