...
# Συνάρτηση προ-επεξεργασίας της εικόνας εισόδου
...
# Φόρτωση του αποθηκευμένου μοντέλου με χρήση του pickle
...
# Χρήση file dialog για επιλογή εικόνας
...
# Προ-επεξεργασία της εικόνας εισόδου και δημιουργία πρόβλεψης κλάσης
preprocessed_img = preprocess_image(input_image_path)
predicted_class = loaded_model.predict([preprocessed_img])[0]
